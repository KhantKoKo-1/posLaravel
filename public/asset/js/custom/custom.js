...
for (var i = 0; i < 30; i++) {
    ...
    chart_plot_02_data.push([currentDate.getTime(), randNum() + i + i + 10]);
}
...
function init_daterangepicker_single_call() {
    ...
    $('#start_date').click(function() {
        ...
        start_date.data('daterangepicker').maxDate = moment(end, 'MM/DD/YYYY').subtract(1, 'days');
        if (start_date.data('daterangepicker').isShowing) {
    ...
    $('#end_date').click(function() {
        ...
        end_date.data('daterangepicker').minDate = moment(start, 'MM/DD/YYYY').add(1, 'days');
        if (end_date.data('daterangepicker').isShowing) {
            end_date.data('daterangepicker').updateView();
        }
    });

    var start_date_picker = $('#start_date_picker').daterangepicker({
        autoUpdateInput: false,
        singleDatePicker: true,
        singleClasses: "picker_1",
    }, function (start, end, label) {
...
function init_charts() {
    ...
    if ($('#lineChart').length) {
        $.ajax({
            url: '/sg-backend/graph/monthly-report',
            method: 'GET',
            dataType: 'json',
                ...
                var lineChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            pointHoverBorderColor: "rgba(220,220,220,1)",
                            pointBorderWidth: 1,
                            data: response.amounts.map(amount => parseInt(amount))
                        }]
                    }
                });
            },
                        ...
                        tooltips: {
                            callbacks: {
                                label: function(tooltipItem, data) {
                                    ...
                                    var label2 = data.labels2[tooltipItem.index];
                                    return datasetLabel + label + '( ' + label2 + ')  Qty -' + value;
                                }
                            }
                        }
                    }
                        ...
                        tooltips: {
                            callbacks: {
                                label: function(tooltipItem, data) {
                                    ...
                                    var datasetLabel = data.datasets[tooltipItem.datasetIndex].label || '';
                                    var value = data.datasets[tooltipItem.datasetIndex].data[tooltipItem.index];
                                    var dateLabel = dateLabels[tooltipItem.index]; // Get the additional label for the current item
                                    return datasetLabel  + dateLabel + ' (' + label + ') Qty - ' + value;
                                }
                            }
                        }
                    }

...
@if (isset($id))
	<section class="section-content padding-y-sm bg-default" ng-app="myApp" ng-controller="myCtrl" ng-init="init({{$id}})">
@else
...
<div class="row">
	<div class="col-md-8 card padding-y-sm card " >
		...
		<button class="btn btn-primary" ng-click="returnBack()" >
			...
			<input type="text" class="form-control" placeholder="Search" ng-model="searchData" ng-keyup = "searchItem()" style="margin-left:10px;">
...
<thead class="dlist-align">
	<tr>
		...
		<!-- <th scope="col" width="120">Code No</th> -->

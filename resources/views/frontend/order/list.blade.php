                                ...
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <form class="form-horizontal pull-right">
                                        <div class="form-group">
                                            ...
                                            <input id="search" name="search" ng-model="searchData"
                                                ng-keyup = "searchOrder()" type="text" class="form-control"
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr ng-repeat="orderData in orderDatas">
                                        <td>
                                            <span
                                                ng-class="{ 'underline-button': orderData.status === 2 }">@{{ orderData.order_no }}</span>
                                        ...
                                        <td>
                                            <a href="{{ asset('order-detail') }}/@{{ orderData.id }}"
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary" ng-if="orderData.status === 0"
                                                ng-click="payOrder(orderData.id)"><i class="fas fa-credit-card"></i>&nbsp;To
                                                Pay</button>
                                            <a href="#" class="btn btn-info" ng-if="orderData.status === 2"
                                                ng-click="confirmBox(orderData.id,0)"><i
                                                    class="fas fa-check">&nbsp;Active</i></a>
                                            <a href="#" class="btn btn-danger" ng-if="orderData.status === 0"
                                                ng-click="confirmBox(orderData.id,2)"><i
                                                    class="fas fa-times">&nbsp;Cancel</i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>

                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-7 col-sm-6 col-6 receipt-btn">
                            <a class="btn print-modal" id="printInvoice"
                                href="{{ asset('order-detail') }}/@{{ orderDetail.id }}">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-6">
                            <span style="font-size: 14px;margin-left:10px;">Date :
                                @{{ orderDetail.created_at['date'] }}</span>
                            &nbsp;&nbsp;&nbsp;
                            ...
                            <div class="table-responsive">
                                <table class="table receipt-table" id="invoice-table">
                                    ...
                                    <tr class="tender" ng-repeat="cashAmount in cashAmounts"
                                        ng-class="{ 'bg-gray': selectIndex.includes(cashAmount.index) }">
                                        <td class="selectedAmount" ng-click="cashMoneyClick(cashAmount.index)">
                                            @{{ cashAmount.cash }}</td>
                                    </tr>
                                    <tr>
                                        <td>Customer Pay</td>
                            ...
                            <div class="row receipt-btn02">
                                <div class="col-md-6 col-sm-6 col-6">
                                    <a class="btn btn-primary view-btn"
                                        href="{{ asset('order-detail') }}/@{{ orderDetail.id }}">VIEW DETAILS</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="payment-cal col-md-12">
                                    <div class="row">
                                        <div class="col-md-12 payment-show">
                                            <p class="amount-quantity" style="min-height: 33px;">@{{ paymentQty }}
                                            </p>
                                        </div>
                                        <div class="col-md-12 receipt-btn3">
                                            <button class="btn quantity" id="1"
                                                ng-click="numberClick(1)">1</button>
                                            <button class="btn quantity" id="2"
                                                ng-click="numberClick(2)">2</button>
                                            <button class="btn quantity" id="3"
                                                ng-click="numberClick(3)">3</button>
                                            <button class="btn quantity" id="4"
                                                ng-click="numberClick(4)">4</button>
                                            <button class="btn quantity" id="5"
                                                ng-click="numberClick(5)">5</button>
                                            <button class="btn quantity" id="6"
                                                ng-click="numberClick(6)">6</button>
                                            <button class="btn quantity" id="7"
                                                ng-click="numberClick(7)">7</button>
                                            <button class="btn quantity" id="8"
                                                ng-click="numberClick(8)">8</button>
                                            <button class="btn quantity" id="9"
                                                ng-click="numberClick(9)">9</button>
                                            <button class="btn quantity" id="0"
                                                ng-click="numberClick(0)">0</button>
                                        </div>
                                        <div class="col-md-12 receipt-btn4">
                                            <button class="btn btn-primary void-btn" id='void-item'
                                                ng-click="void()">VOID
                                                <i class="fas fa-trash-alt"></i></button>
                                            <button class="btn clear-input-btn" ng-click="clearInput()">CLEAR
                                                INPUT</button>
                                            <button class="btn btn-primary foc-btn"
                                                ng-click="storePayment(orderDetail.id)" ng-disabled="!isDisabled">To
                                                Pay</button>
                                        </div>
                                    </div>
                                </div>

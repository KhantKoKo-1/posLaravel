    ...
    <div class="inner">
        <div class="content">
            ...
            <table style="margin:0 auto;width: 18vw;">
                <tr>
                    <td colspan="3">
                        <input type="text" placeholder="Enter Username" class="userInput" name = "username" ng-model = 'username' value = "@{{old('username')}}" ng-focus="usernameFocus()"/>
                    </td>
                </tr>

                <tr>
                    <td colspan="3">
                        <input type="password" placeholder="Enter Password" class="userInput" name = "password" ng-model = 'password' ng-focus="passwordFocus()">
                    </td>
                </tr>

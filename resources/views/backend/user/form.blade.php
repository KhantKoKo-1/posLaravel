            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="">
                        ...
                        @endif
                        @csrf
                        <span class="section"> {{ isset($accountType) && $accountType === 'admin' ? 'Admin Account Info' : 'Cashier Account Info' }} </span>
                        ...
                        <br>
                           @if(!isset($editType) || $editType == 'account_info')
                            <div class="field item form-group">
                                <label for="username" class="col-form-label col-md-3 col-sm-3  label-align">{{ isset($accountType) && $accountType === 'admin' ? 'Admin Name' : 'Cashier Name' }}<span class="required">*</span></label>
                            ...
                            <div class="field item form-group">
                                <label for="old_password" class="col-form-label col-md-3 col-sm-3  label-align">Old Password<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                            ...
                            @if(!isset($editType) || $editType == 'password')
                            <div class="field item form-group">
                                <label for="password" class="col-form-label col-md-3 col-sm-3  label-align">{{ isset($editType) ? 'New password' : 'password' }}<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select id="status" name = "status" class="select2_group form-control">
                                                ...
                                                <option value="0" {{ old('status', isset($account) && $account->status == 0 ? 'selected' : '') }}>Enable</option>
                                                <option value="1" {{ old('status', isset($account) && $account->status == 1 ? 'selected' : '') }}>Disable</option>
                                        </select>
                                    </div>
                            </div>
                            @endif
                            <div class="ln_solid">
                                <div class="form-group">
                                    <div class="col-md-6 offset-md-3">
                                        ...
                                        <input name= 'account_type' type='hidden' value="{{ !isset($accountType) || $accountType !== 'admin' ? 'cashier' : 'admin' }}" ></input>
                                        <input name= 'editType' type='hidden' value="{{ isset($editType) && $editType !== 'password' ? 'company_info' : 'password' }}" ></input>
                                    </div>
                                </div>
                            </div>
                        </form>

                  ...
                  <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        @if($setting != null)
                              ...
                              <td class=""><img src="{{ asset('/storage/upload/setting/' . $setting->id .'/' . $setting->image) }}" alt="" style="width: 100px; height: auto;" /></td>
                              <td class="last">
                              <div class="row">
                                <div class='col-12 col-md-8'>
                                    <a href="{{ url('sg-backend/setting/edit/' . $setting->id) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                </div>
                              </div>
                              </td>
                            </tr>

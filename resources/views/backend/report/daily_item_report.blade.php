                  ...
                  <div class="x_panel">
                    ...
                    <form action="" id="searchForm" method="get">
                      <div class="row">
                        ...
                        <div class="col-2">
                            <input type="text" placeholder="Start Date" class="form-control has-feedback-left" name="start_date_picker" id="start_date_picker" value="{{$start}}" aria-describedby="inputSuccess2Status" readonly>
                        ...
                        <div class="col-2">
                            <input type="text" placeholder="End Date" class="form-control has-feedback-left" name="end_date_picker" id="end_date_picker" value="{{$end}}" aria-describedby="inputSuccess2Status" readonly>
                            <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                            <span id="inputSuccess2Status" class="sr-only">(success)</span>
                        </div>

            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="">
                            @if (isset($category))
                                <form action="{{ route('updateForm') }}" method="POST" enctype="multipart/form-data"
                                    novalidate>
                                    <div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select id="Parent" name="parent_id" class="select2_group form-control">
                                        ...
                                        <option value="0"
                                            {{ old('parent_id', isset($category) ? ($category->parent_id == 0 ? 'selected' : '') : '') }}>
                                            Parent Category
                                        </option>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div id="previous_wrapper"
                                        style="{{ empty($category) ? 'display:block' : 'display:none' }}">
                                        <label class="chooseFile" for="upload" onclick="fileInput()">Choose
                                            Photo</label>
                                    </div>
                                    <div id="previous_wrapper-img"
                                        style="{{ empty($category) ? 'display:none' : 'display:block' }}">

                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="field item form-group">
                                <label for="name" class="col-form-label col-md-3 col-sm-3  label-align">Promotion
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div style="margin-top:9px;">
                                        <input checked type="radio" id="percentage" name="discount_type"
                                            value="percentage"
                                ...
                                @if ($errors->has('discount_type'))
                                    <span class="errorMessage">{{ $errors->first('discount_type') }}</span>
                                @endif
                            </div>
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" class="form-control" id="amount" name="amount"
                                        value="{{ old('amount', isset($discount) ? $discount->amount ?? $discount->percentage : '') }}" />
                                </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select id="Status" name="status" class="select2_group form-control">
                                            <option value="" disabled {{ old('status') == '' ? 'selected' : '' }}>
                                                ...
                                                ONE</option>
                                            <option value="0"
                                                {{ old('status') == 0 || (!old('status') && isset($discount) && $discount->status == 0) ? 'selected' : '' }}>
                                                Enable</option>
                                            <option value="1"
                                                {{ old('status') == 1 || (!old('status') && isset($discount) && $discount->status == 1) ? 'selected' : '' }}>
                                                Disable</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" class="form-control has-feedback-left" name="start_date"
                                        id="start_date"
                                        value="{{ old('start_date', isset($discount) ? dateFormatmdY($discount->start_date) : '') }}"
                            ...
                            <div class="field item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" class="form-control has-feedback-left" name="end_date"
                                        id="end_date"
                                        value="{{ old('end_date', isset($discount) ? dateFormatmdY($discount->end_date) : '') }}"
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="row">
                                        @foreach ($items as $item)
                                            <div class="col-md-4">
                                                <input type="checkbox" class="flat" id="item{{ $item->id }}"
                                                    name="item[]" value="{{ $item->id }}"
                                                    {{ (old('item') && in_array($item->id, old('item'))) ||
                                                    (!old('item') && (isset($discount) && is_array($itemIds) && in_array($item->id, $itemIds)))
                                                        ? 'checked'
                                                        : '' }} />
